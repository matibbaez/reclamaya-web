...
// ❌ BORRAMOS EL IMPORT DE SWEETALERT DE ACÁ ARRIBA
...
export class NavbarComponent implements OnInit {
  ...
  private platformId = inject(PLATFORM_ID); // 🛡️ 1. INYECTAMOS EL ESCUDO
  ...
  onWindowScroll() {
    // 🛡️ 2. BLINDAMOS EL ACCESO A WINDOW
  ...
  // 🛡️ 3. TRANSFORMAMOS LA FUNCIÓN EN ASÍNCRONA PARA EL IMPORT DINÁMICO
  async cerrarSesion() {
    this.menuAbierto = false;

    if (isPlatformBrowser(this.platformId)) {
      // 🛡️ 4. IMPORTAMOS SWEETALERT SOLO EN EL NAVEGADOR
